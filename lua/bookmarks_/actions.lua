local config = require("bookmarks_.config").config
local schema = require("bookmarks_.config").schema
local uv = vim.loop
local Signs = require "bookmarks_.signs"
local utils = require "bookmarks_.util"
local api = vim.api
