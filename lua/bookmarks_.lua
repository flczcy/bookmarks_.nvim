local void = require("bookmarks_.async").void
local scheduler = require("bookmarks_.async").scheduler
local api = vim.api
-- local uv = vim.loop
local current_buf = api.nvim_get_current_buf
local config = require "bookmarks_.config"
local nvim = require "bookmarks_.nvim"
local hl = require "bookmarks_.highlight"
local actions = require "bookmarks_.actions"
